      ...
      <section id="pricing" className="py-16 md:py-24 px-6 bg-circa-green-light">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-2xl mx-auto">
            Choose the right plan for your organization's size and needs, with flexible options as you grow.
          </p>
            ...
            <Card className="border-gray-200">
              <CardContent className="pt-6">
                <div className="text-center mb-6">
                  ...
                  <div className="text-3xl font-bold mb-1">$299<span className="text-lg font-normal text-gray-500">/mo</span></div>
                  <p className="text-gray-500 text-sm">Billed annually</p>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-circa-green mr-2" />
                    <span className="text-gray-600">Up to 500 data points</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-circa-green mr-2" />
            ...
            <Card className="border-circa-green shadow-lg relative">
              ...
              <CardContent className="pt-6">
                <div className="text-center mb-6">
                  ...
                  <div className="text-3xl font-bold mb-1">$699<span className="text-lg font-normal text-gray-500">/mo</span></div>
                  <p className="text-gray-500 text-sm">Billed annually</p>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
