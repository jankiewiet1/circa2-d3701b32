...
serve(async (req) => {
  try {
    ...
    const supabaseServiceRoleKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZmZGJ5dm5qaGltbW5ieWh4eXVuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NDYzOTYxNCwiZXhwIjoyMDYwMjE1NjE0fQ.2dmWAge0FVBFOJKSC6vIc5PJRGKTB0WVJO-hznkTWSg'
    const openaiApiKey = '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'
